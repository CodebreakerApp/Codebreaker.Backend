...
public class CodeBreakerExtensionsTests
{
    ...
    { 
        Game expected = new("79fa64d6-9ba7-4e56-90b6-8ed7aba3c6e1", "test", new[] {"green", "green", "yellow", "green"} );
        CodeBreakerGame dbGame = new("79fa64d6-9ba7-4e56-90b6-8ed7aba3c6e1", "green..green..yellow..green", "test", DateTime.Now);
