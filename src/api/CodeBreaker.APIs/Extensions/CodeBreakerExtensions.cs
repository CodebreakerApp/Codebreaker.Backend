...
internal static class CodeBreakerExtensions
{
    public static Game ToGame(this CodeBreakerGame dbGame)
    {
        ...
        return new Game(dbGame.CodeBreakerGameId, dbGame.GameType, dbGame.User, codes);
    }

    public static CodeBreakerGame ToDataGame(this Game game)
    {
        return new CodeBreakerGame(game.GameId, game.GameType, string.Join("..", game.Code), game.Name, DateTime.Now);
    }
}
