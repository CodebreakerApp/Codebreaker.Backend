...
internal static class CodeBreakerExtensions
{
    public static Game ToGame(this CodeBreakerGame dbGame)
    {
        ...
        return new Game(dbGame.CodeBreakerGameId, dbGame.GameType, dbGame.User, codes, dbGame.ColorList, dbGame.Holes, dbGame.Time);
    }

    public static CodeBreakerGame ToDataGame(this Game game)
    {
        return new CodeBreakerGame(game.GameId, game.GameType, string.Join("..", game.Code), game.Name, game.Holes, game.ColorList.ToArray(), DateTime.Now);
    }
}
